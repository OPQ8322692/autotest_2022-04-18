...
from testcase.utest_userlogin import form_data_list_masterapp
...
#师傅app登录数据
data_masterapp = form_data_list_masterapp[0]
...
@pytest.fixture(scope="class")
def get_token_masterapp():
    token_masterapp = Pre_login.test_login_masterapp(data_masterapp)
    return token_masterapp
